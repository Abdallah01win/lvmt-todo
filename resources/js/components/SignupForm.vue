<template>
  ...
  >
    <h2 class="text-gray-900 text-xl font-medium title-font mb-5">Sign Up</h2>
    <div class="relative mb-4">
      <label for="full-name" class="leading-7 text-lg text-gray-600">Full Name</label>
      <input
        type="text"
        id="full-name"
        name="full-name"
    ...
    <div class="relative mb-4">
      <label for="password" class="leading-7 text-lg text-gray-600">Password</label>
      <input
        type="password"
        id="password"
        name="password"
